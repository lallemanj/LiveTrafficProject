...
namespace LiveTrafficProject.Controllers
{
    public class IncidentsController : Controller
    {
        ...
        {
            ViewData["propertiesId"] = new SelectList(_context.Set<Properties>(), "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,type,propertiesId")] Incident incident)
        {
            ...
            ViewData["propertiesId"] = new SelectList(_context.Set<Properties>(), "Id", "Id", incident.propertiesId);
            return View(incident);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,type,propertiesId")] Incident incident)
        {
            if (id != incident.Id)
            {
                return NotFound();
