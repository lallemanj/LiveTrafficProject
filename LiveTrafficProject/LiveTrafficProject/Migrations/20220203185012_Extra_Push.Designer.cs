...
namespace LiveTrafficProject.Migrations
{
    ...
    [Migration("20220203185012_Extra_Push")]
    partial class Extra_Push
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiveTrafficProject.Areas.Identity.Data.LiveTrafficProjectUser", b =>
                {
            ...
            modelBuilder.Entity("LiveTrafficProject.Models.Incident", b =>
                {
                    ...
                    b.Property<string>("propertiesId1")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("propertiesId1");

                    b.ToTable("Incident");
                });

            modelBuilder.Entity("LiveTrafficProject.Models.Language", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(2)
                        .HasColumnType("nvarchar(2)");
            ...
            modelBuilder.Entity("LiveTrafficProject.Areas.Identity.Data.LiveTrafficProjectUser", b =>
                {
                    b.HasOne("LiveTrafficProject.Models.Language", "Language")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LiveTrafficProject.Areas.Identity.Data.LiveTrafficProjectUser", null)
                        .WithMany()
